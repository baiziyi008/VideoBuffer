...
import com.megvii.videobuffer.VideoActivity;
...
//				long generateIndex = 0;
				...
				while (isRuning) {
					...
					if (VideoActivity.YUVQueue.size() >0){
						input = VideoActivity.YUVQueue.poll();
	...
	private void signalEndOfInputStream(){
		...
		if (inputBufferIndex >= 0){
			...
			inputBuffer.clear();
			mediaCodec.queueInputBuffer(inputBufferIndex, 0, 0, pts, MediaCodec.BUFFER_FLAG_END_OF_STREAM);
		}
	}
